(function (angular) {
  ...
  ch.factory('contentHolder', ["$rootScope", "contentHolderConfig", "$location", function ($rootScope, contentHolderConfig, $location) {
  ...
  ch.directive('contentView', ["contentHolder", "$compile", function (contentHolder, $compile) {
  ...
  ch.directive('contentHolder', ["contentHolder", function (contentHolder) {
    return {
      restrict: 'ECA',
      terminal: true,
      scope: true,
